...
# ── Shared infrastructure (reused from V1, never modified) ──
...
def send_daily_newsletter():
    ...
    try:
            ...
            <body style="font-family:Arial,sans-serif;padding:20px;background:#f8f9fa;">
                <div style="max-width:600px;margin:0 auto;background:#fff;padding:30px;
                    ...
                    <p style="color:#4b5563;font-size:15px;line-height:1.6;">
                        <strong>BizNess Tip:</strong> Keeping energy overhead below 15% increases
        ...
        """
        for sub in res.data:
            send_email(sub["email"], "Your Daily BizNess Insight 📈", tip_html)
...
async def lifespan(app: FastAPI):
    print("🚀 BizNess OS V2 starting up...")
    ...
    print("🛑 BizNess OS V2 shutting down...")
    scheduler.shutdown()
...
def root():
    return {
        "message": "✅ BizNess OS V2 is running!",
        "v1_endpoints": "/api/v1/...",
        "v2_endpoints": "/api/v2/...",
        "docs": "/docs"
    }
